 ...
 *   - `isLargeSpike: true` — max price ≥ 200%, confirmed Large Spike
 *   - `isLargeSpike: null` — P1→P2 seen but no data after it; ambiguous (both spike types still possible)
 *   - `isLargeSpike: false` — data after sequence confirms it is NOT Large Spike
 *   - `spikePhase1` — phase 1 data (only present when detected via P1→P2 sequence, not the fallback path)
 */
