...
export function reasonsToRejectSmallSpike(knownPrices, buyPrice) {
  ...
  if (confirmation.detected) {
    ...
    // Use strict > to avoid falsely rejecting when the confirmation price is exactly at the Phase 1 max (140%).
    // 140% is the upper boundary of Small Spike Phase 0/1 (90-140%) and must not be treated as Phase 2.
