...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.getElementById('confidencePanel').addEventListener('click', toggleView);
  document.getElementById('debugInfo').addEventListener('click', toggleView);
  ...
  function applyViewPreference() {
    ...
    resultsGrid.classList.toggle('compact-view', view === 'compact');
  }

  function toggleView() {
    const isCompact = resultsGrid.classList.contains('compact-view');
    const newView = isCompact ? 'detailed' : 'compact';
    resultsGrid.classList.toggle('compact-view', newView === 'compact');
