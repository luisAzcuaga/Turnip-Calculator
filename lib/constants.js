...
export const PERIODS = {
  ...
  // Semantic aliases
  SMALL_SPIKE_START_MIN: 0,   // Monday AM   — earliest Small Spike start
  LARGE_SPIKE_START_MIN: 1,   // Monday PM   — earliest Large Spike start (game allows spike from Mon PM)
...
export const RATES = {
  ...
  DECREASING: {
    ...
    MIN_DROP_RATE: 0.03,  // 3% - best case (drops less)
    MAX_DROP_RATE: 0.05,  // 5% - worst case (drops more)
  },
  ...
  FLUCTUATING: {
    MIN: 0.50,             // 50%
    MAX: 1.40,             // 140%
    EXCLUSIVE_EARLY_MIN: 0.90,  // 90% — above this on Monday AM, only Fluctuating is possible
  },
};
