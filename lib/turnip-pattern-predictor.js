...
export default class TurnipPatternPredictor {
  ...
  execute() {
    ...
    const primaryPattern = patternResult.primary;
    const predictions = {};
    ...
    return {
      ...
      patternName: PATTERN_NAMES[primaryPattern],
      primaryPercentage: patternResult.percentages[primaryPattern],
      ...
      recommendations: this.getRecommendations(primaryPattern),
      bestSellDay: this.getBestSellDay(predictions, primaryPattern),
